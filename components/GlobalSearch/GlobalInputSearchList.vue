<template>
    ...
    >
        ...
        >
            ...
            <div>
                <p v-if="item.name" v-html="generateNewName(item?.name)"></p>
                <p
                    v-else-if="item.original_title"
                    v-html="generateNewName(item?.original_title)"
                ></p>
                <p
...
watchEffect(() => {
    array.value = props.searchList.slice(0, 10);
});
</script>
